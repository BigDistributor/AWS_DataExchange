...
//                    this.n5 = new N5FSReader( n5File.getAbsolutePath() );
    ...
    {
        final String pathName = BdvN5Format.getPathName( setupId );
        final DataType dataType = n5.getAttribute( pathName, BdvN5Format.DATA_TYPE_KEY, DataType.class );
        switch ( dataType )
        {
            case UINT8:
            ...
            implements MultiResolutionSetupImgLoader< T >
    {
        ...
        public Dimensions getImageSize(final int timepointId, final int level )
        {
            try
            {
                final String pathName = BdvN5Format.getPathName( setupId, timepointId, level );
